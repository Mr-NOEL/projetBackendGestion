 ...
 */
final class Version20201104174750 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE vetement (id INT AUTO_INCREMENT NOT NULL, type_id INT NOT NULL, descriptif VARCHAR(255) NOT NULL, prix_de_base NUMERIC(5, 2) NOT NULL, taille INT NOT NULL, date_achat DATE NOT NULL, INDEX IDX_3CB446CFC54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
